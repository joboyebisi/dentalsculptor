...
export function CommunityActions({ projectId, initialLikes, initialLiked, signedIn = true }: { projectId: string; initialLikes: number; initialLiked: boolean; signedIn?: boolean }) {

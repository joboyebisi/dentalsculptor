...
| 3.4 | Replace CPU trimesh stub with real Nano3D Case 3 | ⬜ | `nano3d_utils.py` |
| 3.5 | Wire reference image + camera through API → Modal | ⬜ | |
| 3.6 | EditJob Prisma model + revision history | ⬜ | |
| 3.7 | Edit presets (add/remove/replace cusp, smooth, etc.) | ⬜ | UX quick wins |
| 3.8 | Before/after 3D compare + accept/reject | ⬜ | Partial in editor |
